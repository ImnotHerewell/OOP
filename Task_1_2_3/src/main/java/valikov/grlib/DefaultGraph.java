 ...
 */
public class DefaultGraph<E, N> implements Graph<E, N> {
    private Map<N, Node<E, N>> mapOfAllNodes = new HashMap<>();
    ...
    private void dijkstraStep(Node<E, N> minNode,
        ...
        for (var edge : minNode.getListOfEdges()) {
            ...
            if (mapWeights.get(minNode) + weight < mapWeights.get(to)) {
                ...
                toNodeValue = new NodeValue<>(toNodeValue.first(),
                        mapWeights.get(minNode) + weight);
     ...
     */
    public DefaultGraph<E, N> removeNode(N identifier) {
        if (identifier == null) {
            throw new IllegalArgumentException("Null pointers are not supported.");
        }
        if (!mapOfAllNodes.containsKey(identifier)) {
     ...
     */
    public DefaultGraph<E, N> setNodeIdentifier(N identifier, N newIdentifier) {
    ...
    public boolean equals(Object o) {
        ...
        @SuppressWarnings("unchecked") DefaultGraph<E, N> graph = (DefaultGraph<E, N>) o;
