...
set CLASSPATH=%APP_HOME%\lib\test-1.0-SNAPSHOT.jar


@rem Execute test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_OPTS%  -classpath "%CLASSPATH%" com.gradle.tutorial.FizzBuzzProcessor %*
