...
public class PetukhonApplication extends GameApplication {
    ...
    public static boolean hasIntProperty(String key) {
    ...
    protected void initInput() {
        FXGL.onKeyDown(KeyCode.W, "UP", () -> player.getComponent(SnakeHeadComponent.class)
                                                    .setDirection(Direction.UP));
        FXGL.onKeyDown(KeyCode.A, "LEFT", () -> player.getComponent(SnakeHeadComponent.class)
                                                      .setDirection(Direction.LEFT));
        FXGL.onKeyDown(KeyCode.S, "DOWN", () -> player.getComponent(SnakeHeadComponent.class)
                                                      .setDirection(Direction.DOWN));
        FXGL.onKeyDown(KeyCode.D, "RIGHT", () -> player.getComponent(SnakeHeadComponent.class)
    ...
    protected void initGameVars(Map<String, Object> vars) {
        vars.put("Food", properties.getInt("Food"));
    ...
    protected void initPhysics() {
        ...
        world.addCollisionHandler(Collisions.clashBetweenHeadAndFood());
        world.addCollisionHandler(Collisions.clashBetweenHeadAndDecoration());
        world.addCollisionHandler(Collisions.clashBetweenHeadAndTail());
